...
# kluczowe jest to, ze nie moge bezposrednio porownywac datetime (str) z date. 
# wiec po sparsowaniu inoutu od uzytkownika musze uzyc metody date()
...
def summer_this_year(date_today: str)-> bool:
    ...
    Returns:
        True if the summer will be the same year. False if the summer will be the next year.
    """  
...
def main():
    input_date = input(f"Zeby sprawdzic ile czasu zostalo do najblizszego poczatku lata, podaj date w formacie dd.mm.rrr: \n")
